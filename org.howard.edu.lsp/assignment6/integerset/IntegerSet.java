...
public class IntegerSet {
    ...
    public static ArrayList<Integer> intersectAndUnionsetholder = new ArrayList<Integer>();
    ...
    public boolean equal(ArrayList<Integer> b) {
        ...
        int newLength = 0;
        int counter = 0;
        // System.out.println("The content of the main List are : " +
        // toString(this.set));
    ...
    public void union(ArrayList<Integer> b) {
        ...
        Scanner in = new Scanner(System.in);
        intersectAndUnionsetholder.clear();
        ...
        if (b.isEmpty() && setB.isEmpty()) {
            ...
            for (Integer s : unionSet) {
                intersectAndUnionsetholder.add(s);
    ...
    public boolean isEmpty(ArrayList<Integer> b){
        if(b.isEmpty()){
            return true;
        }
        else{
